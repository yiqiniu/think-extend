                ...
                case 'POST':
                    if ($upload) {
                        ...
                        if (!empty($file) && file_exists($file)) {
                            $response = Http::asMultipart($input_name, file_get_contents($file), $input_name, $header)
                                ->post($url, $params);
                        } else {
            ...
            switch (strtoupper($method)) {
                ...
                case 'POST':
                    if ($upload) {
                        ...
                        if (!empty($file) && file_exists($file)) {
                            Http::asMultipart($input_name, file_get_contents($file), $input_name, $header)
...
if (!function_exists('arrayToXml')) {
    ...
    {
        return yiqiniu\extend\library\ArrayToXml::convert($array, $root, $replaceSpaces, $xmlEncoding, $xmlVersion, $domProperties);
    }
}
...
if (!function_exists('xmlToArray')) {
    ...
    {
        return \yiqiniu\extend\library\XmlToArray::convert($xml);
    }
}
