...
use yiqiniu\extend\library\{Arrays, Date, ExportFile, Http, Logger, Pingyin, Redis, Str, Token};
 ...
 * @method Str          Str() static 字符串相关
 * @method Token        Token() static JWT相关
 * @method ExportFile    ExportFile() static 导出文件
 */
